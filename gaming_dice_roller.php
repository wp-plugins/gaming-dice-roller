...
class gaming_dice_roller extends WP_Widget {
	...
	public static function load_scripts() {
		wp_enqueue_script("gaming_dice_roller_scripts", WP_PLUGIN_URL . "/gaming_dice_roller/gdr_scripts.js", array("prototype"));
		wp_localize_script("gaming_dice_roller_scripts", 'gaming_dice_roller_ajax', array('url' => admin_url('admin-ajax.php')));
		wp_enqueue_script("prototype");
	}
	
	public static function load_styles() {
		wp_enqueue_style("gaming_dice_roller_styles", WP_PLUGIN_URL . "/gaming_dice_roller/gdr_styles.css");
	}
	...
	public function widget($args, $instance) {
		...
		<p id="gaming_dice_roller_link"><a href="htt://www.awesomedice.com">Awesome Dice</a></p>
